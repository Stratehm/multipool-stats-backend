...
@Component("coinshiftRequestStatsLoggingService")
public class RequestStatsLoggingServiceImpl implements RequestStatsLoggingService {

	private static final Logger LOGGER = LoggerFactory.getLogger("coinshiftRequestStats");
	...
	private AtomicInteger nbInitialization;
	...
	public void initializeAddress() {
		nbInitialization.incrementAndGet();
	}
	...
	private void logStats() {
		...
		LOGGER.debug("Nb initialization requests: {}.", nbInitialization.intValue());
		LOGGER.debug(" ");
		LOGGER.debug(" ");
		LOGGER.debug(" ");
