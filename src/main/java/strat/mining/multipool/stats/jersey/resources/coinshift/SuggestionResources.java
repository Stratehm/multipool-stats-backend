...
@Component(value = "coinshiftSuggestionResources")
@Path("coinshift/suggest")
...
public class SuggestionResources {
	...
	@Resource(name = "coinshiftAddressSuggestionService")
	...
	public AddressSuggestionDTO getAddressSuggestions(@HeaderParam("user-agent") String userAgent, @Context HttpServletRequest request,
		...
		USE_LOGGER.debug("Get coinshift address suggestions for {}.", requestData.getAddressPattern());
