...
@Component(value = "waffleSuggestionResources")
@Path("waffle/suggest")
...
public class SuggestionResources {
	...
	@Resource(name = "waffleAddressSuggestionService")
	...
	public AddressSuggestionDTO getAddressSuggestions(@HeaderParam("user-agent") String userAgent, @Context HttpServletRequest request,
		...
		USE_LOGGER.debug("Get waffle address suggestions for {}.", requestData.getAddressPattern());
