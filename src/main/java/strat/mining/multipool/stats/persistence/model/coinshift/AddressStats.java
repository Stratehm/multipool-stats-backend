 ...
 */
package strat.mining.multipool.stats.persistence.model.coinshift;
...
public class AddressStats {
	...
	private Float rejectedHashRate;
	...
	public Float getRejectedHashRate() {
		return rejectedHashRate;
	}

	public void setRejectedHashRate(Float rejectedHashRate) {
