...
import strat.mining.multipool.stats.client.mvp.view.middlecoin.component.AddressChartPanel;
import strat.mining.multipool.stats.client.mvp.view.middlecoin.component.GlobalChartPanel;
...
public class MiddlecoinViewImpl extends AbstractPoolView implements MiddlecoinView {

	private MiddlecoinView.MiddlecoinViewPresenter presenter;
	...
	private TextButton openMiddlecoinTwitterTimelineButton;
	...
	public MiddlecoinViewImpl(final MiddlecoinView.MiddlecoinViewPresenter presenter) {
		super(presenter);
		...
		openMiddlecoinTwitterTimelineButton = new TextButton("Open timeline @Middlecoinpool");
		openMiddlecoinTwitterTimelineButton.setIcon(ClientResources.INSTANCE.twitterBlue());
		openMiddlecoinTwitterTimelineButton.addSelectHandler(new SelectHandler() {
			public void onSelect(SelectEvent event) {
				presenter.openMiddlecoinTwitterWindow();
			}
		});

		getGlobalToolbar().add(openMiddlecoinTwitterTimelineButton);
	...
	public void appendGlobalStats(GlobalStatsDTO stats, GlobalAggregatedStats aggreagatedSats) {
		if (globalChart != null) {
			globalChart.appendGlobalStats(stats, aggreagatedSats);
		}
	}
