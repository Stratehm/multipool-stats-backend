...
public class HashrateCell extends AbstractCell<Float> {

	private static final NumberFormat numberFormat = NumberFormat.getFormat("0.000");

	private Float threshold;

	public HashrateCell(Float threshold) {
