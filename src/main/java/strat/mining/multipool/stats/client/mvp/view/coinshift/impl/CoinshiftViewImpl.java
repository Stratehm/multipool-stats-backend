 ...
 */
package strat.mining.multipool.stats.client.mvp.view.coinshift.impl;
...
import strat.mining.multipool.stats.client.mvp.view.coinshift.component.AddressChartPanel;
import strat.mining.multipool.stats.client.mvp.view.coinshift.component.GlobalChartPanel;
...
public class CoinshiftViewImpl extends AbstractPoolView implements CoinshiftView {

	private CoinshiftView.CoinshiftViewPresenter presenter;
	...
	private TextButton openCoinshiftTwitterTimelineButton;
	...
	public CoinshiftViewImpl(final CoinshiftView.CoinshiftViewPresenter presenter) {
		super(presenter);
		...
		openCoinshiftTwitterTimelineButton = new TextButton("Open timeline @CoinShift");
		openCoinshiftTwitterTimelineButton.setIcon(ClientResources.INSTANCE.twitterBlue());
		openCoinshiftTwitterTimelineButton.addSelectHandler(new SelectHandler() {
			public void onSelect(SelectEvent event) {
				presenter.openCoinshiftTwitterWindow();
			}
		});

		getGlobalToolbar().add(openCoinshiftTwitterTimelineButton);
	...
	public void setGlobalStats(List<GlobalStatsDTO> stats) {
		globalChart = new GlobalChartPanel("Coinshift");
