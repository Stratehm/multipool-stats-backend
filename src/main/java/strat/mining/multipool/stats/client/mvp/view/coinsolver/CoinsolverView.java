...
public interface CoinsolverView extends IsWidget, PoolView {

	public interface CoinsolverViewPresenter extends PoolPresenter<CoinsolverPoolPlaceDescriptor>,
			PoolViewPresenter<CoinsolverView, CoinsolverPoolPlaceDescriptor> {
