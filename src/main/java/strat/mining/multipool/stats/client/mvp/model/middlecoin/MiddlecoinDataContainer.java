...
public class MiddlecoinDataContainer {
	...
	private GlobalAggregatedStats globalAggregatedStats;
	...
	public GlobalAggregatedStats getGlobalAggregatedStats() {
		if (globalAggregatedStats == null) {
			globalAggregatedStats = new GlobalAggregatedStats();
		}
		return globalAggregatedStats;
	}
