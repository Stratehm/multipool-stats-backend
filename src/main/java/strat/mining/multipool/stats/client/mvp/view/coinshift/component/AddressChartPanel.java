...
public class AddressChartPanel implements IsWidget {
	...
	private HorizontalLayoutContainer lastStatsPanel;
	...
	private void initPowerChart() {
		...
		rejectedMHSeries.setPlotOptions(new AreaPlotOptions().setShadow(false).setHoverStateLineWidth(2).setColor(new Color(190, 0, 0, 0.5))
				.setFillOpacity(0.5));
		...
		powerChart.setToolTip(new ToolTip().setFormatter(new ToolTipFormatter() {
			public String format(ToolTipData toolTipData) {
				...
				if (stat != null) {
					String rejectedMHPercentValue = nf.format((((stat.getRejectedMegaHashesPerSeconds()) * 100F) / (stat
							.getRejectedMegaHashesPerSeconds() + stat.getMegaHashesPerSeconds())));
					...
					result += "<br/><b>Total MH/s:</b> "
							+ formatPowerValue((stat.getRejectedMegaHashesPerSeconds() + stat.getMegaHashesPerSeconds()));
	...
	public void setAddressStats(List<AddressStatsDTO> stats) {
		...
		for (AddressStatsDTO stat : stats) {
			...
			rejectedMHSeries.addPoint(time, stat.getRejectedMegaHashesPerSeconds());
	...
	public interface HtmlLayoutContainerTemplate extends XTemplates {
		@XTemplate("<table width=\"100%\" height=\"50px\"><tbody><tr><td class=\"label1\" /><td class=\"value1\" /><td class=\"label5\" /><td class=\"value5\" /><td class=\"label9\" /><td class=\"value9\" /></tr><tr><td class=\"label2\" /><td class=\"value2\" /><td class=\"label6\" /><td class=\"value6\" /><td class=\"label10\" /><td class=\"value10\" /></tr><tr><td class=\"label3\" /><td class=\"value3\" /><td class=\"label7\" /><td class=\"value7\" /><td class=\"label11\" /><td class=\"value11\" /></tr><tr><td class=\"label4\" /><td class=\"value4\" /><td class=\"label8\" /><td class=\"value8\" /><td class=\"label12\" /><td class=\"value12\" /></tr></tbody></table>")
