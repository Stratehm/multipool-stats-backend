...
import strat.mining.multipool.stats.client.component.cell.BooleanImageCell;
...
public class PaidoutViewImpl implements PaidoutView {
	...
	public interface AddressPaidoutProperties extends PropertyAccess<AddressPaidoutDTO> {
		...
		ValueProvider<AddressPaidoutDTO, Boolean> isBonus();
	}
	...
	public PaidoutViewImpl(String title) {
		...
		ColumnConfig<AddressPaidoutDTO, Boolean> bonusColumn = new ColumnConfig<AddressPaidoutDTO, Boolean>(propertyAccess.isBonus(), 75, "Bonus");
